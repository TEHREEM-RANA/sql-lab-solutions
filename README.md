...
* **SQL Query Mastery:** Write and optimize core DDL, DML, complex JOIN queries, and aggregate functions.
* **Database Modeling:** Understand entity relationships (1:1, 1:N, N:M), views, and stored procedures.
...
| **Data Types & String Functions** | `VARCHAR`, `INT`, `DECIMAL`, `DATE`, `CONCAT()`, `UPPER()`, `LOWER()`, `LENGTH()` | ✅ Completed |
...
| **Aggregate & Group Functions** | `AVG()`, `COUNT()`, `MAX()`, `MIN()`, `SUM()`, `STDDEV()`, Nesting Group Functions | ✅ Completed |
| **Data Grouping & Filtering** | `GROUP BY` (Single & Multi-Column), Group Restrictions with `HAVING` Clause | ✅ Completed |
| **SQL Views Management** | `CREATE VIEW`, Querying Views, Virtual Join Views, `ALTER VIEW` | ✅ Completed |
| **Stored Procedures (T-SQL)** | System Procedures (`sp_help`, `sp_tables`), User-Defined Procedures, Input Parameters | ✅ Completed |
...
│   └── lab02.sql
└── Lab-03-Group-Functions-Views-And-Procedures/
    └── lab03.sql
```
##  License
